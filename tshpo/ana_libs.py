...
class AnaDataLoader:
    ...
    def load_baseline(cls, csv_file=None):
        ...
        if csv_file is None:
            csv_file = "/Users/xxx/Documents/baseline_original_20241019_0148.csv.gz"
        df = pd.read_csv(csv_file)
...
if __name__ == '__main__':
    # file = "/Users/xxx/Downloads/b00_observation_v3_original_20241018_0321.csv.gz"
    ...
    #     "/Users/xxx/Downloads/b04_ablation_sample_method_original_20241018_0938.csv.gz",
    #     n_explorations=[1, 10, 20, 30])
    # from ana_libs import AnaDataLoader
    #
    # df = AnaDataLoader.load_acc_select_data_v2(
    #     "/Users/xxx/Downloads/b04_ablation_sample_method_original_20241018_1241.csv.gz",
