...
for key, val in kvdb.to_dataframe().iterrows():
    # print(key)
    # key: kr-vs-kp:::gpt-4-turbo
    dataset, gpt_version = val["dataset"], val["gpt_name"]
    suggest_hpy_str = val["suggest"]
    ...
    cs = builder.build_configuration_space(include=[suggest_model_name])
