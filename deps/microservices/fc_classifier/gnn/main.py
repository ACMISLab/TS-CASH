...
from fc_vgae.fcvgae.kvdb_json import KVDBJson
...
if __name__ == '__main__':
    ...
    if args.dataset_name == "D1":
        ...
        loader = D2()
    train_samples = load_pkl(f"data/{loader.DATA_NAME}/chunk_train.pkl")
    test_samples = load_pkl(f"data/{loader.DATA_NAME}/chunk_test.pkl")
    ...
    test_loader = create_dataloader(test_samples, 128)
