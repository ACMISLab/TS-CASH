...
smac_v12_path = os.path.abspath(os.path.join(os.path.dirname(__file__)))
# 将 smac_v12 路径添加到 sys.path
if smac_v12_path not in sys.path:
    sys.path.append(smac_v12_path)
import platform
import time
import types
import uuid
...
class AutoML(BaseEstimator):
    ...
    def fit(
        ...
        try:
            ...
            # TODO: SW: we disable this for debugging
