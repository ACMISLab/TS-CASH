...
class SGD(
    ...
    def get_hyperparameter_search_space(
        ...
        # sklearn.utils._param_validation.InvalidParameterError: The 'loss' parameter of SGDClassifier must be a str among {'hinge', 'squared_epsilon_insensitive', 'squared_hinge', 'modified_huber', 'perceptron', 'huber', 'epsilon_insensitive', 'squared_error', 'log_loss'}. Got 'log' instead.
