...
scenario.load(Path("/Users/xxx/Research/pylibs/pylibs/smac3/tests/2"))
print(scenario)
conf = OptConf(
    exp_name='effect_n_trials_2024_03_29',
    job_name='autoscaling_data_False',
    out_home=Path(
        '/remote-home/cs_acmis_xxx/experiment_results/automl_results/debug_False/effect_n_trials_2024_03_29'),
    dataset_name='YAHOO',
    ...
    out_dir=PosixPath('/Users/xxx/Research/pylibs/pylibs/smac3/tests/2'),
    index=4,
    total=180,
    test_rate=0.4,
    n_trials=100,
