from pylibs.evaluation.common import (
...
def contextual_confusion_matrix(expected, observed, data=None,
    ...
    Args:
        expected (DataFrame or list of tuples):
            ...
            two columns: start_or_restart and stop.
        ...
        data (DataFrame):
            ...
            Used to extract start_or_restart and end.
        start (int):
    ...
    if not isinstance(expected, list):
        expected = list(expected[['start_or_restart', 'end']].itertuples(index=False))
    if not isinstance(observed, list):
        observed = list(observed[['start_or_restart', 'end']].itertuples(index=False))
