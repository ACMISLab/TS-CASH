...
class VUSMetrics:
    ...
    def range_recall_new(self, labels, preds, alpha):
        ...
        Nr = len(range_label)  # exp_total # of real anomaly segments
    ...
    def extend_postive_range(self, x, window=5):
        ...
        L = self.range_convers_new(label)  # exp_index of non-zero segments
        length = len(label)
...
def generate_curve(label, score, slidingWindow):
    tpr_3d, fpr_3d, prec_3d, window_3d, avg_auc_3d, avg_ap_3d = VUSMetrics().RangeAUC_volume(labels_original=label,
                                                                                             score=score,
