...
if __name__ == '__main__':
    print(str2hash("1"))
    print(str2hash(
        "{'__choice__': 'adaboost', 'algorithm': 'SAMME.R', 'dataset': 'dresses-sales', 'fold_index': 0.0, 'learning_rate': 0.010591, 'max_depth': 8.0, 'model': 'adaboost', 'n_estimators': 195.0, 'random_state': 42.0}"))
