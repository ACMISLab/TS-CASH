...
class Server:
    ...
    work_home: str = "/remote-home/cs_acmis_xxx/"
    # 存储数据用的地方
    ...
    debug: bool = False
    pylibs_home: str = "/remote-home/cs_acmis_xxx/2024/pylibs"
    ...
    def upload_tailscale(self,
                         tailscale_path: Path = Path("/Users/xxx/Nextcloud/App/tailscale/tailscale_1.60.0_amd64/")):
        """
    ...
    def prepare_dataset(self):
        _local_home = Path("/Users/xxx/Documents/uts_benchmark_dataset/benchmark")
        _remote_home = Path("/remote-home/cs_acmis_xxx/uts_benchmark_dataset")
    ...
    def push_pylibs_to_gitea(self):
        print(BashUtil.exe_cmd("cd /Users/xxx/Research/pylibs;make p"))
    ...
    def install_pylibs_by_pip(self, client):
        ...
        [
            "git+http://aa9d08e0f02e1c17f2a5e4d744549b45396e9117@your_server_ip:15000/xxx/pylibs.git@master"
        ],
            pip_options=["--upgrade"])
