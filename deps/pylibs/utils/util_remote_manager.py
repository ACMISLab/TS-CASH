...
class ESC:
    GPU_100_9_LAN = ExpServerConf(ip='your_server_ip',
                                  ...
                                  runtime="/remote-home/xxx/cs_acmis_xxx/runtime/")
    ...
    CPU_10_219_LAN = ExpServerConf(ip='your_server_ip',
                                   ...
                                   username="root",
                                   password="your_server_password",
                                   runtime="/remote-home/cs_acmis_xxx/sw_research_code/runtime/")
    ...
    LOCAL_HOST = ExpServerConf(ip=None,
                               ...
                               username=None,
                               password=None,
                               runtime="/Users/xxx/Downloads/download_metrics/")


class HOMEConf:
    GPU_10_153 = "/remote-home/acmis_fdd/sw_research_code/runtime/"
    GPU_100_9 = "/remote-home/xxx/cs_acmis_xxx/runtime/"
    LOCAL_HOME = "/Users/xxx/Downloads/download_metrics/"
...
class RC:
    ...
    REMOTE_HOME = "/remote-home/xxx/cs_acmis_xxx/sw_research_code/"
    REMOTE_HOME_ENV = "/remote-home/xxx/cs_acmis_xxx/sw_research_code/environments/"
    ...
    GPU_100_9 = ServerConfig(**{
        ...
        "password": 'acmis',
        "real_ip": "your_server_ip",
        "work_home": "/remote-home/xxx/cs_acmis_xxx/sw_research_code/A01_paper_exp"
    })
    ...
    GPU_100_9 = ServerConfig(**{
        ...
        "real_ip": "your_server_ip",
        "work_home": "/remote-home/xxx/cs_acmis_xxx/runtime/"
    })
...
def remote_run_exp(args):
    ...
    def run_100_9():
        ...
        ssh.send("cd /remote-home/xxx/cs_acmis_xxx/sw_research_code/A01_paper_exp;conda activate base")
        ssh.send("pkill screen")
        ssh.send(f"export EXP_VERSION={JobConfV1.EXP_VERSION}")
        ssh.send(f"screen python {args.entry}")
...
"""
 sshpass -p acmis rsync  -e "ssh -p 12208" -avi --debug=FILTER --dry-run -f"+ V345\_VUS***" -f"- *" root@your_server_ip:/remote-home/acmis_fdd/sw_research_code/runtime/  /Users/xxx/Downloads/download_metrics/
