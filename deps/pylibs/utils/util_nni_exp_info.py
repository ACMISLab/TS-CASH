...
class NNIExperimentInfo:
    ...
    def _get_experiment_working_directory(self, yaml_info):
        ...
        e.g., /Users/xxx/Research/py-search-lib/nni-experiments
...
class NNIDotExperiment:
    """
    Represents an instance of .experiment: /Users/xxx/nni-experiments/.experiment
    """
    ...
    def __init__(self, user_home=os.path.expanduser('~')):
        ...
        if not os.path.exists(experiment_file):
            ...
            # Represent experiments in /Users/xxx/nni-experiments/.experiment
