...
class NNIManagerLog:
    ...
    def __init__(self, experiment_working_directory, id, file_base_name='nnimanager.log'):
        ...
        # Represents the file /Users/xxx/nni-experiments/test_exp/qc85ane1/log/nnimanager.log
        ...
        # Represents the contents of file /Users/xxx/nni-experiments/test_exp/qc85ane1/log/nnimanager.log
    ...
    def is_experiment_done(self) -> bool:
        """
        Get the status from /Users/xxx/nni-experiments/test_exp/qc85ane1/log/nnimanager.log
        ...
        # "/Users/xxx/nni-experiments/debug_1675855568130661000/qc85ane1/log"
    ...
    def has_error(self):
        ...
        at WebSocket.handleWsClose (/Users/xxx/Research/nni-2.10-mac-m1/ts/nni_manager/dist/core/tuner_command_channel/websocket_channel.js:83:26)
        at WebSocket.emit (node:events:538:35)
        at WebSocket.emitClose (/Users/xxx/Research/nni-2.10-mac-m1/ts/nni_manager/node_modules/express-ws/node_modules/ws/lib/websocket.js:246:10)
        at Socket.socketOnClose (/Users/xxx/Research/nni-2.10-mac-m1/ts/nni_manager/node_modules/express-ws/node_modules/ws/lib/websocket.js:1127:15)
