...
"""
文件夹不存在，就执行命令，否者跳过
test ! -d "/remote-home/cs_acmis_xxx/2024/p3" && echo 1
"""
...
class SSHClient:
    ...
    def kill_program_by_substr(self, name):
        ...
        /root/miniconda3/bin/python /root/miniconda3/bin/supervisord -c /remote-home/cs_acmis_xxx/ssh_tunel_from_S164_to_S153.conf
    ...
    # sshpass -p  'acmis' rsync  -h -e "ssh -p 60013 -o PubkeyAuthentication=yes -o stricthostkeychecking=no" -avi -m   -f"+ */" -f"- ***/.git/***" -f"+ *.py" -f"+ *.sh" -f"+ *.csv" -f"+ **/Makefile"  -f"- *"  --delete /remote-home/cs_acmis_xxx/2024/p2/pylibs/ root@your_server_ip:/remote-home/cs_acmis_xxx/2024/pylibs/
...
if __name__ == '__main__':
    ...
    # ssh.upload_dir("/Users/xxx/Research/Research-code/A01_result_analysis/A01_data_stastics", "/root/")
    # ssh.send("ls /root/")
    # ssh.prepare_env("/Users/xxx/Downloads/download_metrics/V900_01_observation_VUS_ROC_0.001_random/metrics.csv",
    #                 "/root/metrics.csv")
    # ssh.send("ls /root/")

    # 32 = {str} '\x1b[31m2.清理系统盘请参考：https://www.autodl.com/docs/qa/\x1b[0m'
    # 36 = {str} '\x1b[34;42mV900_02_fastuts_VUS_ROC_0.001_random\x1b[0m'
    # 33 = {str} 'root@79bc33a413bc:~# ls /remote-home/cs_acmis_xxx/sw_research_code/runtime/'
