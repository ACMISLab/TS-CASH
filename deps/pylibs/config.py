...
class Env:
    EXP_HOME = "/Users/xxx/Research/pylibs/exps"
    # this directory c"ontains tailscaled and tailscale
    LIB_WHEEL_PATH_REMOTE = "/tmp/pylibs-1.0.0-py3-none-any.whl"
    FRP_EXE_HOME = "/Users/xxx/Nextcloud/App/frp/frp_0.37.1_linux_amd64/"

    # http://your_server_ip:7500
    # http://your_server_ip:7500/
    # FRP_SERVER_LOCAL = "your_server_ip"
    TAILSCALE_SAVE_PATH = "/Users/xxx/Nextcloud/App/tailscale/tailscale_1.60.0_amd64/"
    MACOS_RUNTIME_HOME = "/Users/xxx/runtime"
    SERVER_RUNTIME_HOME = "/remote-home/cs_acmis_xxx/runtime"
    LOCAL_PYLIBS_EGG = "/Users/xxx/Research/pylibs/dist/pylibs-1.0.0-py3.10.egg"
    LOCAL_PYLIBS_WHEEL = "/Users/xxx/Research/pylibs/dist/pylibs-1.0.0-py3-none-any.whl"
    REMOTE_PYLIBS_HOME: Path = Path("/remote-home/cs_acmis_xxx/automl/deps/pylibs")
    DEV_PYLIBS_WHEEL = "/remote-home/cs_acmis_xxx/2024/pylibs/dist/pylibs-1.0.0-py3-none-any.whl"
    DEV_PYLIBS_HOME: str = "/remote-home/cs_acmis_xxx/2024/p2/pylibs"
    LOCAL_PYLIBS_HOME: Path = Path("/Users/xxx/SW-OpenSourceCode/AutoML-Benchmark/deps/pylibs/")
    REMOTE_WORK_HOME: Path = Path("/remote-home/cs_acmis_xxx/2024/p2/")
    LOCAL_WORK_HOME: Path = Path("/Users/xxx/Research/AutoML")
    ...
    def get_frpc_home(cls):
        if platform.system() == "Linux":
            return "/remote-home/cs_acmis_xxx/app/frp_0.37.1_linux_amd64"
        else:
    ...
    def get_supervisord_exe(cls):
        if is_linux():
            ...
            return "/Users/xxx/miniforge3/envs/autosklearn/bin/supervisord"
    ...
    def get_python_exe():
        if is_linux():
            ...
            # return "/Users/xxx/miniforge3/envs/amltk/bin/python"
            return "/Users/xxx/miniforge3/envs/autosklearn/bin/python"

    @staticmethod
    def get_exp_results_save_home():
        if is_linux():
            return "/remote-home/cs_acmis_xxx/experiment_results"
        else:
            return "/Users/xxx/Documents/experiment_results"
    ...
    def get_frpc_exe_path():
        if is_linux():
            ...
            return "/Users/xxx/Nextcloud/App/npc/frp_0.37.1_darwin_amd64/frpc"

    @classmethod
    def get_script_home(cls):
        if is_linux():
            return Path("/remote-home/cs_acmis_xxx/2024/pylibs/exps").as_posix()
        else:
            return Path("/Users/xxx/Research/pylibs/exps").as_posix()
