...
docker run -d --restart=always -p 33306:3306  --name mysql901_tshpo -v /docker/appdata/mysql901_tshpo/my.cnf:/etc/mysql/my.cnf  -v /docker/appdata/mysql901_tshpo/data:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=your_password  -v /etc/localtime:/etc/localtime registry.cn-hangzhou.aliyuncs.com/xxxer/common:mysql_9_0_1
