...
def get_analysis_args(command=None):
    ...
    parser.add_argument("--metric_dir",
                        default="/Users/xxx/Research/Research-code/A01_paper_exp/results/test_task_2023_07_07_v1/iforest/ECG",
...
if __name__ == '__main__':
    ...
    args = get_analysis_args(["--metric_dir",
                              "/Users/xxx/Research/Research-code/A01_paper_exp/results/test_iforest_Daphnet_2023_07_07_v1"])
    ay = FileGathers(args)
    ay.load_all_metrics()
