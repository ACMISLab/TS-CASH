...
if __name__ == "__main__":
    # execute-algorithm '{"executionType": "", "dataInput": "/data/dataset.csv", "dataOutput": "/results/anomaly_scores.ts", "modelInput": "/model/model.txt", "modelOutput": "/model/model.txt"}'
