...
class PCA(DetectorB):
    ...
    n_selected_components : int, optional (default=None)
        ...
        the exp_total number of the principal components. If not set, use
    ...
    def fit(self, X, y=None):
        ...
        # fix: ValueError: n_components=25 must be between 0 and min(n_samples, n_features)=2 with svd_solver='full'
