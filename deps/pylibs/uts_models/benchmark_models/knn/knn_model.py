...
class KNN:
    ...
    leaf_size : int, optional (default = 30)
        ...
        speed of the construction and exec, as well as the memory
    ...
    def fit(self, X, y=None):
        ...
        # Fix:  ValueError: Expected n_neighbors < n_samples_fit, but n_neighbors = 96, n_samples_fit = 96, n_samples = 96
        if self.neigh_.n_neighbors >= self.neigh_.n_samples_fit_:
            self.n_neighbors=self.neigh_.n_samples_fit_-1
