...
class CBLOF(BaseDetector):
    ...
    def _set_small_large_clusters(self, n_samples):
        # Sort the exp_index of clusters by the number of samples belonging to it
        ...
        # Initialize the lists of exp_index that fulfill the requirements by
        ...
        for i in range(1, self.n_clusters_):
            ...
            # Find the separation exp_index fulfills both alpha and beta
