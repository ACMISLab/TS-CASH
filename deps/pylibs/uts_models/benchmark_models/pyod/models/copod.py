...
class COPOD(BaseDetector):
    ...
    def explain_outlier(self, ind, columns=None, cutoffs=None,
        ...
        ----------
        ind : int
            The exp_index of the data point one wishes to obtain
        ...
        Plot : matplotlib plot
            The dimensional outlier graph for data point with exp_index ind.
        """
        if columns is None:
    ...
    def score(self, X):
        # return self.predict_proba(X,method="unify")[:, 1]
