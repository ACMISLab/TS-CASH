...
## Get the same logger from main_dask"
...
def prediction_spk(args, cdc_model, spk_model, device, data_loader, batch_size, frame_window):
    ...
    with torch.no_grad():
        for [data, target] in data_loader:
            ...
            pred = output.max(1, keepdim=True)[1]  # get the exp_index of the max log-probability
    ...
    logger.info("===> Final predictions mark_as_finished. Here is a snippet")
