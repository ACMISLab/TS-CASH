...
from .DetectorConfig import _CPCConf
from .network.model.model import CDCK2
from .network.training_v1 import train, snapshot
from ..cpc_conf import CPCConf
from ...coca.utils import ScheduledOptim
...
class CPC(DetectorBase):
    ...
    def __init__(self, config: _CPCConf):
