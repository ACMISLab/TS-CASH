...
def train(n_epochs=2000):
    ...
    for epoch in range(n_epochs):
        ...
        UtilSys.is_debug_mode() and logging.debug('Critic training mark_as_finished in epoch {}'.format(epoch))
        encoder_loss = list()
        decoder_loss = list()
        ...
        # UtilSys.is_debug_mode() and logging.debug('Encoder decoder training mark_as_finished in epoch {}'.format(epoch))
