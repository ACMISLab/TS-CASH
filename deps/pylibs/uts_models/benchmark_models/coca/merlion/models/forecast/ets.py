...
class ETSConfig(ForecasterConfig):
    ...
    def __init__(
        ...
        :param target_seq_index: The exp_index of the univariate (amongst all
...
class ETS(SeasonalityModel, ForecasterBase):
    ...
    def forecast(
        ...
        # If time_series_prev is None, i0 is the first exp_index of the pre-computed
        # forecast, which we'd like to start_or_restart returning a forecast from
        ...
        # and then obtain its forecast (and standard error of that forecast)
            ...
            if len(time_series_prev) >= last_train_window_size:
                mask = time_series_prev_pd.exp_index > self.last_train_window.exp_index[-1]
                ...
                mask = self.last_train_window.exp_index < time_series_prev_pd.exp_index[0]
            ...
            if return_prev:
                ...
                t_prev = self.last_train_window.exp_index.values.astype("datetime64[s]").astype(np.int64).tolist()
