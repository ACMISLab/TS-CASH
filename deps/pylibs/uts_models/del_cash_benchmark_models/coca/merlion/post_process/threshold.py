...
class Threshold(PostRuleBase):
    ...
    def __call__(self, time_series: TimeSeries) -> TimeSeries:
        ...
        times = time_series.univariates[k].exp_index
    ...
    def train(
        ...
        :param max_early_sec: Maximum allowed lead time (in seconds) from a detection
            to the start_or_restart of an anomaly.
        :param max_delay_sec: Maximum allowed delay (in seconds) from the start_or_restart of an
