...
class SVM(DetectorB):
    ...
    def __init__(self, kernel='rbf', degree=3, gamma='auto', coef0=0.0,
                 ...
                 verbose=False, max_iter=500, contamination=0.1):
        super(SVM, self).__init__(contamination=contamination)
        self.detector_ = None
        self.kernel = kernel
    ...
    def fit(self, X_train, Y_train, sample_weight=None, **params):
        ...
        self.detector_ = SVC(max_iter=self.max_iter,probability=True)
        self.detector_.fit(X_train, Y_train)
