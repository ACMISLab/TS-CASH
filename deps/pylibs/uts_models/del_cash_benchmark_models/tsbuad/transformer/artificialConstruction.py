...
def construct_anomaly(X_train, y_train, clusterIndex, K=3, anomalyRatio=0.05, seed=0, return_statistics=False):
    ...
    ano_labels = np.where(clusterIndex == 1)[
                     0] + 1  # list of ano labels, add 1 since label exp_index start_or_restart from 1
    ...
    if return_statistics:
        ...
        if num_nor_label == 1:
            ...
            # split exp_index according to label
