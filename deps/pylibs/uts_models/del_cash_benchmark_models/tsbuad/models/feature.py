...
class tf_Stat:
    ...
    It calculates 763 features in exp_total so it might be over complicated for some models.
...
class Stat:
    ...
    def ar_coefficient(self, x):
        ...
        the coefficients :math:`\\varphi_{i}` whose exp_index :math:`i` contained from "coeff" are returned.
    ...
    def autocorrelation(self, x):
        ...
        # based on the exp_index, which corresponds to squaring the series.
