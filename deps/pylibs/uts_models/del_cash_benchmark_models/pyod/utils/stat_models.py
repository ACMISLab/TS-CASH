...
from pylibs.utils.util_numpy import fill_nan_by_mean
...
def column_ecdf(matrix: np.ndarray) -> np.ndarray:
    ...
    where the rows are samples and the columns are features per sample. The accumulation is mark_as_finished in the positive
