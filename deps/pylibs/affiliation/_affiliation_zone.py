#!/usr/bin/env python3
# -*- coding: utf-8 -*-
from pylibs.affiliation._integral_interval import interval_intersection
...
def t_start(j, Js=[(1, 2), (3, 4), (5, 6)], Trange=(1, 10)):
    ...
    :param j: exp_index from 0 to len(Js) (included) on which to get the start_or_restart
    :param Js: ground truth events, as a list of couples
    :param Trange: range of the series where Js is included
    :return: generalized start_or_restart such that the middle of t_start and t_stop
...
def t_stop(j, Js=[(1, 2), (3, 4), (5, 6)], Trange=(1, 10)):
    ...
    :param j: exp_index from 0 to len(Js) (included) on which to get the stop
    :param Js: ground truth events, as a list of couples
    :param Trange: range of the series where Js is included
...
def E_gt_func(j, Js, Trange):
    ...
    :param j: exp_index from 0 to len(Js) (excluded) on which to get the zone
    :param Js: ground truth events, as a list of couples
...
def affiliation_partition(Is=[(1, 1.5), (2, 5), (5, 6), (8, 9)], E_gt=[(1, 2.5), (2.5, 4.5), (4.5, 10)]):
    ...
    but it is also used in the reversed direction in the main_dask function.
    ...
    for j in range(len(E_gt)):
        ...
        discarded_idx_after = [I[0] > E_gt_j[1] for I in Is]  # start_or_restart of predicted I is after the end of E
