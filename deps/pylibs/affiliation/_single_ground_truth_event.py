...
# -*- coding: utf-8 -*-
import math
from pylibs.affiliation._affiliation_zone import (
    get_all_E_gt_func,
    affiliation_partition)
from pylibs.affiliation._integral_interval import (
...
def affiliation_precision_distance(Is=[(1, 2), (3, 4), (5, 6)], J=(2, 5.5)):
    ...
    :param J: couple representating the start_or_restart and stop of a ground truth interval
...
def affiliation_precision_proba(Is=[(1, 2), (3, 4), (5, 6)], J=(2, 5.5), E=(0, 8)):
    ...
    :param Is: list of predicted events within the affiliation zone of J
    :param J: couple representating the start_or_restart and stop of a ground truth interval
    :param E: couple representing the start_or_restart and stop of the zone of affiliation of J
