...
def get_series(num):
    ...
    num_str = '%03d' % num
    file_name = ""
    for filename in os.listdir("/Users/xxx/SW-OpenSourceCode/AutoML-Benchmark/deps/datasets/ucr/data/"):
        x = filename.split('_')
        if x[0] == num_str:
            file_name = filename
            for line in open(
                    os.path.join("/Users/xxx/SW-OpenSourceCode/AutoML-Benchmark/deps/datasets/ucr/data/", filename)):
