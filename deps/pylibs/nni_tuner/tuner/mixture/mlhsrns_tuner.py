...
from sample_base.mlhs_sampling import MLHSSampling
...
class MLHSRNSTuner(BaseTuner):
    ...
    def update_search_space(self, search_space):
        ...
        sampler = MLHSSampling(self.round_sample_size[0], self.search_space)
    ...
    def get_parameters(self, parameter_id):
        ...
        if _round == 0:
            ...
            round_sample = self.get_round_constraint(_round, MLHSSampling)
