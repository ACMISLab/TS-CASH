...
from sample_base.random_sampling import RandomSampling
from tuner.base_tuner import BaseTuner

log = logging.getLogger("lhs_run_tuner.LHSRNSTuner")
...
class RSRRSTuner(BaseTuner):
    ...
    def update_search_space(self, search_space):
        ...
        sampler = RandomSampling(self.round_sample_size[0], self.search_space)
    ...
    def get_parameters(self, parameter_id):
        ...
        if _round == 0:
            ...
            round_sample = self.get_round_constraint(_round, RandomSampling)
