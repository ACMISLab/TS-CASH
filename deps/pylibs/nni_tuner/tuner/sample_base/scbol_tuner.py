...
class SCBOLTuner(BaseTuner):
    """
    A nni_tuner using Scbol method. This nni_tuner only use the sample method to work.
    """
    ...
    def update_search_space(self, search_space):
        ...
        sampler = ScbolSamplingPySample(self.n_trails, self.search_space)
