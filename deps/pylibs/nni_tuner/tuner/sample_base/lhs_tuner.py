...
class LHSTuner(BaseTuner):
    """
    A nni_tuner using LHS method. This nni_tuner only use the sample method to work.
    """
    ...
    def update_search_space(self, search_space):
        ...
        sampler = LHSSamplingPySample(self.n_trails, self.search_space)
