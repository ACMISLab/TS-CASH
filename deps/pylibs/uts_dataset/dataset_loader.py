...
class KFoldDatasetLoader:
    ...
    def __init__(self,
        ...
        #     self._dataset_home), "Home of dataset must be specified by Environment Variable DATASET_HOME, such as export DATASET_HOME=/Users/xxx/Documents/uts_benchmark_dataset/benchmark/ \n Under the benchmark directory, it contains " \
    ...
    def get_dataset_home():
        ...
        default_home = Path("/remote-home/cs_acmis_xxx/uts_benchmark_dataset")
        if default_home.exists():
            return default_home
        else:
            home = UtilSys.get_environ_by_key("DATASET_HOME")
            assert home is not None and os.path.isdir(
                home), f"{default_home} is not existed. So you has to set environment variable DATASET_HOME, such as export DATASET_HOME=/Users/xxx/Documents/uts_benchmark_dataset/benchmark/ \n Under the benchmark directory, it contains " \
                       "multiple datasets such as:  \nbenchmark/Daphnet \nbenchmark/SMD \nbenchmark/..."
            return home
