...
class NNIExperimentUtils:
    ...
    def __init__(self, exp_ids, home_for_nni_experiments="/Users/xxx/SyncResearch/nni-experiments", max_sequence=-1,
                 exp_name=""):
        ...
        home_for_nni_experiments:str
            存储实验的路径，即 nni-experiments 的绝对路径, 如 /Users/xxx/nni-experiments
        max_sequence: int
