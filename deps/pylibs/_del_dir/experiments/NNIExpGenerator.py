...
class NNIExpGenerator:
    ...
    **Experiment parameter(generating experiments for nni) starts np_**,
    ...
    def _prepare_search_space_file(self):
        ...
        '/Users/xxx/SyncResearch/p1_ch05/experiments/search_spaces/deepsvdd_search_space.json'
        Returns
        -------
        str
    ...
    def _get_config_home(self):
        """
        Get the config home of NNI experiments, e.g., '/Users/xxx/SyncResearch/p1_ch05/experiments/configs'
    ...
    def _get_dispatcher_log_file(self):
        ...
        e.g., '/Users/xxx/nni-experiments/jvg6t9e2/log/dispatcher.log'
