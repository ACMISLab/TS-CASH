...
class TestDatasetLoader(unittest.TestCase):
    ...
    def test_demo(self):
        conf = np.load(
            "/Users/xxx/Research/runtime/exp_name/model_name1691919077.297033/dataset_name1691919077.297036/metrics/ae9104b26bc684dda81034d5d6b2cfe2ccd4d5bb_score.npz",
            allow_pickle=True)
        print(conf)

    def test_metrics(self):
        score = "/Users/xxx/Downloads/download_metrics/V472_observation_v6_VUS_ROC_0.001_random/lstm/Daphnet/metrics/0f59a954e1dbb5764eb9d0b14a7da7ab70342203_score.npz"
