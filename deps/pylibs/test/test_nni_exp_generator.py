...
nni.report_final_result({
    ...
    def test_start(self):
        cmd = "nnictl create  --port 49493 --config /Users/xxx/Research/p1_ch05/experiments/configs/DEBUG_1672124080472839000_DID-DATA_ID_DAT-DEBUG_NTR-RANDOM_MTN-1_MTC-1_RET-0_SED-0_DSM-RANDOM_DSR-1.0_MON-DEFAULT_MEF-MAIN.yaml"
        # cmd = "where nnictl"
    ...
    def test_reg(self):
        message = """
          File "/Users/xxx/Research/nni-2.10/nni/experiment/launcher.py", line 105, in start_experiment
    _ensure_port_idle(port)
  File "/Users/xxx/Research/nni-2.10/nni/experiment/launcher.py", line 185, in _ensure_port_idle
...
RuntimeError: Port 49493 is not idle """
    ...
    def test_create_experiment2(self):
        cmd = "nnictl create --port 57191 --config /Users/xxx/Research/p1_ch05/experiments/configs/DEBUG_1675858846692219000_DID-A07AC296-DE40-3A7C-8DF3-91F642CC14D0_DAT-IOPSCOMPETITION_NTR-RANDOM_MTN-4_MTC-1_RET-0_SED-0_DSM-RANDOM_DSR-1.0_MON-DEFAULT_MEF-MAIN_SK.yaml --debug "
        # create_nni_experiment(cmd)
        create_nni_experiment(cmd)
