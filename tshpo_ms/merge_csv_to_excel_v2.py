...
from fcvgae.libs import load_pkl
...
def merge_csv_to_excel(input_dir, output_file):
    ...
    # 获取所有CSV文件
    csv_files = glob.glob(os.path.join(input_dir, "*.pkl"))
    ...
    # 合并所有数据框
    print("正在合并数据...")
    merged_df = pd.DataFrame(all_dataframes)
...
if __name__ == "__main__":
    input_directory = "./results/v2"
    output_file = "./results/v2.xlsx"
